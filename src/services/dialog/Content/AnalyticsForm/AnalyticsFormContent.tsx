...
import useFilterStore from "../../../stores/analyticsStore";
...
function EmptyState({ text }: { text: string }) {
  return (
    <div className="flex min-h-55 items-center justify-center rounded-xl border border-dashed border-gray-200 bg-gray-50 p-6 text-sm text-gray-500">
      {text}
    </div>
  );
}
...
export function AnalyticsFormContent({
  startDate,
  endDate,
}: {
  startDate: string;
