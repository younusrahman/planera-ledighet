...
import { useTeams, useEmployees } from "../../../hooks/useData";
  ...
  return (
    <div className="relative w-full">
      ...
      <button
        ...
        className="flex min-h-10 w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 text-left text-sm shadow-sm transition hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-200"
      >
      ...
      {open && (
        <div className="absolute z-50 mt-1 max-h-100 w-full overflow-auto rounded-md border border-gray-200 bg-white shadow-lg">
          {children}
        </div>
      )}
    </div>
