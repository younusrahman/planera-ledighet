...
import { AnalyticsFormContent } from "./AnalyticsFormContent";
import { FilterBar } from "./FilterBar";
import { useEmployees, useAbsenceCategories } from "../../../hooks/useData";
...
export function AnalyticsForm() {
  ...
  return (
    <div className="space-y-6 ">
      ...
      <AnalyticsFormContent startDate={startDate} endDate={endDate} />
    </div>
  );
}
