...
import { DnD } from "./DndTimelIne/Dnd";
import {
  useTeamMutation,
  useEmployeeMutation,
...
export const LeaveRequest = () => {
  ...
  const openAnalyticsDashboard = () => {
    dialog.open(
      "analytics",
      { Icon: DataReportIcon, title: "Analytics Dashboard" },
      "lg",
    );
  };
  ...
  const handleDialogDatabaseSystemTrigger = () => {
    dialog.open("databaseMaintenance", {
      Icon: DatabaseConfigurationIcon,
      title: "Databassystem",
    });
  };
